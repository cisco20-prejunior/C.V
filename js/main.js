    window.addEventListener("scroll", ()=>{
        ...
        } else if ($word.classList.contains("habilidades__word__after")&& ($distanciaWord <  50 || $distanciaWord > 710)) {
        ...
        } else if ($excel.classList.contains("habilidades__excel__after")&& ($distanciaExcel <  50 || $distanciaExcel > 720)) {
        ...
        } else if ($ingles.classList.contains("habilidades__ingles__after")&& ($distanciaIngles <  50 || $distanciaIngles > 720)) {
